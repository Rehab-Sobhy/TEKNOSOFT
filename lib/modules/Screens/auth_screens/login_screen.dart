...
import 'package:new_app/modules/Screens/auth_screens/register_screen.dart';
import 'package:new_app/modules/Widgets/login_widgets/drop_down_widget.dart';
import 'package:new_app/modules/Widgets/login_widgets/text_field_widget.dart';
                          ...
                          child: ListView(
                            children: [
                              ...
                              DropDownWidget(
                                  ...
                                  onChanged: (val) =>
                                      authCubit.changeDropDownValue(val: val!)),
                              SizedBox(
                                height: 25,
                              ),
                              MaterialButton(
